...
// num2 but not num1?
    //  num1 strictly includes values 2-9 but excludes 1 and 10 whereas
    //  num 2 includes values 1-10 and does not exlude the outer bounds because of the "or equal to" in the comparison
...
// Place your answer below:
    // I thought it would be null but I tested it out in the console and it is undefined
...
// This is easy. 
// I used MDN to check if javascript separated numbers into integers and floats or if they are just number data types
// I used the chrome console to check my answers and commented if my expected answer was different than the actual answer
